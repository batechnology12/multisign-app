...
class FlutterPainterExample extends StatefulWidget {
  ...
  String image;
  FlutterPainterExample({Key? key, required this.image}) : super(key: key);
...
class _FlutterPainterExampleState extends State<FlutterPainterExample> {
  ...
  Widget buildDefault(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: ValueListenableBuilder(
          valueListenable: controller,
          builder: (context, _, __) => Container(height: 80,
            child: Row(crossAxisAlignment: CrossAxisAlignment.start,
              ...
              // :
                ...
                IconButton(
                  icon: Icon(
                       Icons.text_fields,
                    color: textFocusNode.hasFocus ? Colors.red : null,
                  ),
                  onPressed: addText,
                ),
                // Add sticker image
  ...
  void renderAndDisplayImage() async {
    ...
    Get.find<HomeController>().pickedEditedImagePathList = [imageFuture];
