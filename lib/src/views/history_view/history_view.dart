                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Text(
                          multisign.projectDetails[index].letters.toString(),
                          style: primaryFonts.copyWith(
                              fontSize: 26,
                      ...
                      Column(
                        ...
                        children: [
                          Text(multisign.projectDetails[index].name.toString(),
                              style: primaryFonts.copyWith(
                                  fontSize: 15,
                                  fontWeight: FontWeight.w600,
                                  color: AppColors.black)),
                          Text(multisign.projectDetails[index].place.toString(),
                              style: primaryFonts.copyWith(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w400,
                                  color: AppColors.black.withOpacity(.70))),
                          Text(multisign.projectDetails[index].jobId.toString(),
                              style: primaryFonts.copyWith(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w400,
                      ...
                      Column(
                        ...
                        children: [
                          Text(multisign.projectDetails[index].date.toString(),
                              style: primaryFonts.copyWith(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w300,
                                  color: AppColors.black)),
                          Text(multisign.projectDetails[index].day.toString(),
                              style: primaryFonts.copyWith(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w300,
                                  color: AppColors.black)),
