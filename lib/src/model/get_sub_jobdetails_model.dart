...
//
//     final getReceeSubjobDetailsModel = getReceeSubjobDetailsModelFromJson(jsonString);

import 'dart:convert';

GetReceeSubjobDetailsModel getReceeSubjobDetailsModelFromJson(String str) => GetReceeSubjobDetailsModel.fromJson(json.decode(str));

String getReceeSubjobDetailsModelToJson(GetReceeSubjobDetailsModel data) => json.encode(data.toJson());

class GetReceeSubjobDetailsModel {
    bool status;
    subjobdatailsdata data;

    GetReceeSubjobDetailsModel({
        required this.status,
        required this.data,
    });

    factory GetReceeSubjobDetailsModel.fromJson(Map<String, dynamic> json) => GetReceeSubjobDetailsModel(
        status: json["status"],
        data: subjobdatailsdata.fromJson(json["data"]),
    );
...
class subjobdatailsdata {
    ...
    String isDeleted;
    dynamic deletedAt;
    List<dynamic> receeVerifications;
    ...
    factory subjobdatailsdata.fromJson(Map<String, dynamic> json) => subjobdatailsdata(
        id: json["id"],
        ...
        receeVerifications: List<dynamic>.from(json["recee_verifications"].map((x) => x)),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "recee_verifications": List<dynamic>.from(receeVerifications.map((x) => x)),
    };
}
